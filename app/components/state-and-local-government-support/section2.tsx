  ...
  return (
    <section className="staffing-services">
      ...
      <p className="staffing-services-description">
        ...
        recruit, and place skilled professionals to support our clients' projects and initiatives.
        <br />
        We have been Registered with the following Federal, State & Local Governments to provide IT
        Staffing & Services.
      </p>
