                ...
                <div className="faq-card flex flex-col ">
                  <div className="flex flex-row w-full">
                    <div className="flex w-1/2">
                      <div className="item" style={{ fontSize: '1.4rem', cursor: 'pointer' }}>
                        {faq}
                      </div>
                    </div>
                    <div className="flex w-1/2 justify-end" onClick={() => handleFaqClick(faq)}>
                      <div className="ellipse-container">
                        <img src="../assets/Ellipse.svg" alt="Ellipse" className="ellipse-image" />
                        {selectedFaq === faq && faqAddState[faq] != null ? (
                          <img src="../assets/Minus.svg" alt="Minus" className="minus-image" />
                        ) : (
                          <img src="../assets/Add.svg" alt="Add" className="add-image" />
                        )}
                      </div>
                    </div>
                  </div>
