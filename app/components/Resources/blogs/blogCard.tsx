...
const BlogCard = ({ blog,blogData }: { blog: IBlogMedia, blogData:any }) => {
    ...
    return(
        <div className="lg:h-96 w-full lg:flex grid gap-4 sm-card-p">
          <img src={blog?.bannerImage.url} className="flex lg:h-full lg:w-fit w-full h-40 lg:aspect-square object-cover"/>
          <div className="flex-1 flex flex-col h-full lg:pb-3 lg:px-2 gap-3 2xl:max-w-3xl xl:max-w-2xl lg:max-w-xl sm:max-w-sm max-w-xs sm:w-auto w-64">
              ...
              <div className="line-clamp-2 lg:text-3xl sm:text-2xl text-lg self-stretch text-black  font-montserrat font-semibold whitespace-pre-wrap">{blog.title}</div>
