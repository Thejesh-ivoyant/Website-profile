...
const JobCards = () => {
  ...
  const handleFilterAndSearchDown = async () => {
    setLoading(true)
    const updatedJobsQuery = SearchJobs(
      dep || '',
      exp || '',
      role || '',
      loc || '',
      ...
      <div className="technology-section gap-3 section-p-y">
        <section className="heading gradient-bottom grid gap-3">
          ...
          <p className="sub-details">
            "Email your resume/CV with the job code mentioned above to jobs@ivoyant.com and let us
            help you discover a great career"!
          </p>
        </section>
          ...
          <div className="flex flex-col gap-1 w-full lg:px-28 px-4">
            ...
            <div className="grid gap-4 mx-auto">
              ...
              <div className="flex gap-4 jobs-filter">
                ...
                <button
                  onClick={showDrawer}
                  className="filter-mobile flex justify-center cursor-pointer items-center px-3 py-2 border-solid border-[0.5px] border-indigo-950 max-w-[40px]"
                >
                  <img
                    loading="lazy"
                      ...
                      <div className="justify-between w-full bg-white p-6 items-stretch flex gap-4  max-md:flex-wrap">
                        ...
                        <div className="items-center self-center flex aspect-square flex-col justify-center my-auto">
                          ...
                          >
                            ...
                            />
                            <path
                              d="M24.5 20.5 17 28l-1.05-1.05 6.45-6.45-6.45-6.45L17 13z"
                              fill="#F0F5FF"
                            />
                          </svg>
                        </div>
