  ...
  return (
    <>
      <div className="w-full">
        <button onClick={() => onToggle(num)} className="capitalize w-full flex flex-row">
          ...
          {active ? (
            ...
            >
              <path d="m5 .551 5 6-.7.7-4.3-4.3-4.3 4.3-.7-.7 5-6Z" fill="#fff" />
            </svg>
          ) : (
            <svg
              className="my-auto ml-auto"
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <path d="m5 6.449-5-5 .7-.7 4.3 4.3 4.3-4.3.7.7-5 5Z" fill="#fff" />
            </svg>
          )}
        </button>
