        ...
        <ul role="navigation">
                  ...
                  item.__typename !== 'ComponentCardCard' && (
                    <li className="item" key={item.id}>
                      {item.attachment?.data?.attributes?.url ? (
                        ...
                        <Link to={item?.link} prefetch="intent" aria-label={item?.name}>
                          {item?.name}
                        </Link>
                      )}
                    </li>
                  ...
                  item.__typename !== 'ComponentCardCard' && (
                    <li className="item" key={item.id}>
                      {item.attachment?.data?.attributes?.url ? (
                        ...
                        <Link aria-label={item?.name} to={item.link} prefetch="intent">
                          {item.name}
                        </Link>
                      )}
                    </li>
          ...
          <li>
            ...
            <ul className="list_container">
              ...
              <li className="item">
                <Link to={'/cookies'} aria-label="Cookie policy">
                  {' '}
                  Cookie policy{' '}
                </Link>
              </li>
              <li className="item">
                <Link to={'/terms-and-conditions'} aria-label="T & C">
                  {' '}
                  Terms & Conditions{' '}
                </Link>
              </li>
