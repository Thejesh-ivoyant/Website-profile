                ...
                <div className="flex flex-col">
                  <div className="flex items-start py-3 gap-2">
                    <div className="flex flex-col footer-font justify-center">
                      ...
                      <a href="mailto:sales@ivoyant.com" className="hover:font-semibold">
                        sales@ivoyant.com
                      </a>
                    </div>
                  </div>
                ...
                <div className="flex flex-col items-start py-3 gap-4">
                  <div className="flex flex-col footer-font justify-center gap-4">
                    <div className="grid gap-1">
                      ...
                      <a href="mailto:info@ivoyant.com" className="hover:font-semibold">
                        info@ivoyant.com
                      </a>
                    </div>
                    <div className="grid gap-1">
                      <span className="">For Future developers</span>
                      <a href="mailto:jobs@ivoyant.com" className="hover:font-semibold">
                        jobs@ivoyant.com
                      </a>
                    </div>
        ...
        <div className="grid place-items-center md:hidden">
          ...
          <span className="flex gap-2 py-4">
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              <img src={linkedin} alt="Linked-in" className="h-5 object-contain cursor-pointer" />
            </a>
            <a href="https://www.youtube.com/@ivoyant" target="_blank" rel="noopener noreferrer">
              <img src={yt} alt="Youtube-channel" className="h-5 object-contain cursor-pointer" />
            </a>
          </span>
          <svg
            className="my-4"
